...
import { IPromoDataType } from "./types"
import "./index.scss"

interface IProps {
  promoData: IPromoDataType
  onEnter?: () => void
}

class ProCardItem extends React.Component<IProps> {
  state = {
    editModalShow: false,
    budgetOption: 1,
    budgetValue: 0,
  ...
  render() {
    const { name, desc, type, btnStatus, cost = 0, budget = 0 } = this.props.promoData
